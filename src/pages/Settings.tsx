      ...
      <Card className="p-5">
        <form onSubmit={handleSaveSettings} className="space-y-5">
          <div className="border-b border-border/60 pb-3">
            <h3 className="text-sm font-bold text-foreground">Gym Information & Branding</h3>
            <p className="text-xs text-muted-foreground">These details appear on printed digital receipts and WhatsApp messages.</p>
          </div>
          ...
          <div className="flex justify-end pt-2">
            <Button type="submit" variant="primary" leftIcon={<Save className="h-4 w-4" />} isLoading={isSaving}>
              Save Settings
            </Button>
          </div>
        </form>
